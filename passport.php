...
<div class="container">
  <h2 style="width: 60%;
       ...
       padding: 20px;">Passport Registration Form</h2>
  ...
  <form method="get" action="<?php echo $_SERVER["PHP_SELF"];?>" style="margin-bottom: 50px;">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="service" placeholder="FRESH/RE-ISSUE" name="service">
    </div>
    <div class="form-group">
          <label for="type">Type of Application</label>
             <input type="text" class="form-control" id="type" placeholder="NORMAL/TATKAAL" name="type">
     </div>
    <div class="form-group">
